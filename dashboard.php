...
// Puedes realizar consultas para obtener información que se mostrará en el dashboard

?>

<div class="app">
	<header class="app-header">
    <link rel="stylesheet" href="css/amorcito.css">
	...
	<div class="app-body">
		<div class="app-body-navigation">
			...
			<footer class="footer">
				<h1>Manjares y Artes<small>©</small></h1>
				<div>
					Manjares y Artes ©<br />
		...
		<div class="app-body-main-content">
			<section class="service-section">
				...
				<div class="tiles">
					...
					<article class="tile">
						<div class="tile-header">
							...
							<h3>
								<span>Gas para Calefacción</span>
				...
				<div class="service-section-footer">
					<p>Los servicios se pagan según el estado actual de la moneda y la tarifa.</p>
				</div>
			</section>
			<section class="transfer-section">
				<div class="transfer-section-header">
					...
					<div class="filter-options">
						<p>Filtro seleccionado: más de 100 $</p>
				...
				<div class="transfers">
					<div class="transfer">
						...
						<dl class="transfer-details">
							<div>
								<dt>Apple Inc.</dt>
								<dd>Pago de Apple ID</dd>
							</div>
							<div>
								<dt>4012</dt>
								<dd>Últimos cuatro dígitos</dd>
							</div>
							<div>
								<dt>28 Oct. 21</dt>
								<dd>Fecha de pago</dd>
		...
		<div class="app-body-sidebar">
			<section class="payment-section">
				...
				<div class="payment-section-header">
					<p>Elige una tarjeta para transferir dinero</p>
					<div>
